...
//Envio por mail
$destinatario = "alejandraplacenti@gmail.com";
$asunto = "Nuevo mensaje de la web";
$cuerpoMensaje = "​Nuevo correo de ".$nombre." <br>Email: ".$email." <br>Mensaje: ".$mensaje." <br>Enviado el ".date("d/m/Y h:m");
...
//Conexion MySQL
  ...
  $user="id9007367_ale";
  $pass="ale1234";
  $bd="id9007367_mensajes ";
  @$conexion=mysqli_connect($host,$user,$pass,$bd) or die("Error en la conexión");
  mysqli_close($conexion);
  
 if ($envio==true) {
  echo "El envío se realizó correctamente.<br>¡Muchas Gracias! ".$nombre;
}else{
